		...
		<div class="container container_seat">
			<div class="row">
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
					<div class="st_bt_top_back_btn st_bt_top_back_btn_seatl float_left">	<a href="{{route('client.movies.booking')}}"><i class="fas fa-long-arrow-alt-left"></i> &nbsp;Back</a>
					</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
					...
					<div class="st_seatlay_btn float_left">	<a href="{{route('client.movies.show.payment')}}">Thanh toán ngay</a>
					</div>
				</div>
			</div>
		</div>
