            ...
            <li class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item">
                        <img src="{{ asset('assets-backend/images/flags/germany.jpg') }}" alt="user-image" class="me-1"
            ...
            <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated dropdown-lg p-0">
                ...
                <div class="p-2">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col">
                            <a class="dropdown-icon-item" href="#">
                                <img src="{{ asset('assets-backend/images/brands/g-suite.png') }}"
                                    alt="G Suite">
                                <span>G Suite</span>
                            </a>
                        </div>
            ...
            <li class="dropdown">
                <a class="nav-link dropdown-toggle arrow-none nav-user px-2" data-bs-toggle="dropdown" href="#"
                    ...
                    <span class="account-user-avatar">
                        <img src="{{ asset('assets-backend/images/users/peony-logo.jpg') }}" alt="user-image" width="32"
